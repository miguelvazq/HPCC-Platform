...
define([
    ...
    "dijit/form/DateTextBox"
                ...
                _TabContainerWidget, FileSpray, DropZonesWidget, ESPRequest, ESPLogicalFile,
                template) {
    return declare("DropZonesWidget", [_TabContainerWidget, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        init: function (params) {
            ...
            var context = this;
            var request ={};
            request['NetAddress'] = params.netAddress;
            request['OS'] = params.os;
            ...
            var dropZonesGrid = registry.byId(this.id + "DropZonesGrid");
            dropZonesGrid.setStore(objStore);
            dropZonesGrid.setQuery(this.getFilter());
            dropZonesGrid.startup();
