        ...
        return declare("HPCCPlatformWidget", [_TabContainerWidget], {
            ...
            init: function (params) {
                ...
                this.ws_store.get("HPCCPlatformWidget_Toolbar_Text").then(function(val){
                    if (val) {
                        context.mainPage.set("iconClass","");
                        context.mainPage.set("showTitle", true);
                        context.mainPage.set("title", val);
                        context.environmentText.set("value", val);
                        context.environmentTextCB.set("value", true);

                        domStyle.set(dom.byId(context.id + "StackController_stub_Main_label"), {
                            fontSize: "16px",
                            fontWeight: "bold"
                        });
                    }
            ...
            _onResetDefaultTheme: function (evt) {
                this.mainPage.set("iconClass","iconLogo");
                this.mainPage.set("showTitle", false);
