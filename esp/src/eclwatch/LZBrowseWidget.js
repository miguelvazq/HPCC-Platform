            ...
            if (this.overwriteCheckbox.checked){
                ...
                FileSpray.FileList({
                    ...
                    if (lang.exists("FileListResponse.files.PhysicalFileStruct", response)) {
                        var fileName = "";
                        var fileExistingList = "";
                        var newFileExistingList = "";
                        ...
                        if (fileName === ""){
                            ...
                            for (var i = 0; i < fileExistingList.length; i++) {
                                newFileExistingList += fileExistingList[i].name + ", ";
                            }
                            alert(newFileExistingList + context.i18n.OverwriteMessage);
                        }
                    }
                });
            }
