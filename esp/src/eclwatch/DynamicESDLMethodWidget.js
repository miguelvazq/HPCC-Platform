...
define([
    ...
    return declare("DynamicESDLMethodWidget", [GridDetailsWidget], {
        ...
        refresh: function (params) {
            ...
            if (params.Methods && !params.Configuration) { //add binding call
        ...
        createGrid: function (domID) {
            ...
            this.dialog = new Dialog({
                title: "Add attributes/values to your method",
                style: "width: 300px;"
            });
            ...
            /*this.saveBindingButton = new Button({
                disabled: true,
                label: "Save"
            ...
            this.addAddAttritbuteButton = new Button({
                ...
                label: "Add Attribute(s)"
            }).placeAt(this.openButton.domNode, "after");
            //tmpSplitter = new ToolbarSeparator().placeAt(this.addAddAttritbuteButton.domNode, "before");
            this.addRemoveAttritbuteButton = new Button({
                disabled: true,
                onClick: function (val) {
                    if (confirm("You are about to remove this attribute. Are you sure you want to do this?")) {
                        var selection = context.grid.getSelected()
                        context._removeAttribute(selection);
                    }
                },
                label: "Remove Attribute(s)"
            ...
            var retVal = new declare([ESPUtil.Grid(false, true)])({
                ...
                columns: {
                    ...
                    Name: tree({ label: 'Methods' }),
                    Attribute: editor({ label: 'Attribute', editor: "text",
                        autoSave: true,
                        ...
                        editorArgs: {
                            required: true,
                            placeholder: "Attributes are required",
                            promptMessage: "Attributes are required",
                        }
                    }),
                    Value: editor({ label: 'Value', editor: "text",
                        autoSave: true,
                        canEdit: function (object, value) {
                            if (object.Attributes || !object.__hpcc_parentName) {
                                return false;
        ...
        _addAttribute: function (attr, val) {
            ...
            WsESDLConfig.ConfigureESDLBindingMethod({
                ...
                if (lang.exists("ConfigureESDLBindingMethodResponse.status", response)) {
                    /*if (response.ConfigureESDLBindingMethodResponse.status.Code === 0) { //this never hits 0 it is set to null
                        context.refresh(context.params);
                    }*/
                    context.refresh(context.params);
                    // /context.
