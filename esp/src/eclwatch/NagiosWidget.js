...
define([
    ...
    "dojo/text!../templates/NagiosWidget.html",
    ...
    "hpcc/TableContainer"
                ...
                _TabContainerWidget, WsMachine, ESPUtil, ESPRequest, ESPDFUWorkunit, DelayLoadWidget, TargetSelectWidget, SelectionGridWidget, ESPTree,
                template) {
    return declare("NagiosWidget", [_TabContainerWidget, ESPUtil.FormHelper], {
        templateString: template,
        baseClass: "NagiosWidget",
        i18n: nlsHPCC,
        ...
        postCreate: function (args) {
            ...
            this.systemHealthTab = registry.byId(this.id + "_SystemHealth");
        ...
        initTab: function () {
            ...
            if (currSel && !currSel.initalized) {
                if (currSel.id == this.systemHealthTab.id) {
                } else {
        ...
        initLandingZonesGrid: function () {
            this.landingZoneStore = new WsMachine.CreateNagiosStore();
                ...
                columns: {
                    ...
                    displayName: tree({
                        ...
                        formatter: function (_name, row) {
                            var name = row.ComponentType;
                            return name;
                        }
                    }),
                    /*filesize: { label: this.i18n.Size, width: 108, sortable: false },*/
                    ComponentStatus: { label: this.i18n.Severity, width: 180, sortable: false,
