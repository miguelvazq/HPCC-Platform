...
import { InputBase, IconButton, Popper, ClickAwayListener, Menu, MenuItem, MenuList, Typography, Paper, Grow, Divider, List, ListSubheader, ListItem, ListItemText, ListItemIcon } from '@material-ui/core';
    ...
    return (
        <>
            <div className={classes.search}>
                ...
                <InputBase
                    placeholder="Search components, query, users, wuids, dfu, ecl (/q: /u: /w: /d: /e:)"
                    classes={{
                            ...
                            <ClickAwayListener onClickAway={handleClose}>
                                <div className={classes.flexCenter}>
                                    <List
                                        ...
                                        subheader={
                                            <ListSubheader component="div" id="nested-list-subheader">Recent Searches</ListSubheader>
                                        }
                                    >
                                    ...
                                    {/* {searchResults.length > 0 ? (
                                        <List dense disablePadding
                                            subheader={
                                                <ListSubheader component="div" id="nested-list-subheader">{componentStatus}</ListSubheader>
                                            }
                                        >
                                        )
                                    ...
                                    {searchResults.length > 0 ? (
                                        <List dense disablePadding
                                            subheader={
                                                <ListSubheader component="div" id="nested-list-subheader">Components</ListSubheader>
                                            }
                                        >
                                            {searchResults.map((item, idx) => (
                                                <ListItem key={idx} role={undefined} dense button className={classes.halfWidthList}>
