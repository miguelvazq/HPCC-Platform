...
interface MainList {
    mainWidget: { [widget: string]: any},
	setMainWidget: (object) => void
}
...
export const MainList: React.FC<MainList> = ({
    ...
    return (
        ...
        >
            <List>
                <ListItem button title="Main Page" onClick={() => setMainWidget({widget:"ActivityWidget", params: {}})}>
                    <ListItemIcon>
                        <HomeIcon />
                    </ListItemIcon>
                ...
                <Collapse in={open === "ECL"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"WUQueryWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "ECL"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"ECLPlaygroundWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Files"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"DFUQueryWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Files"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"LZBrowseWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Files"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"GetDFUWorkunitsWidget", params:{}})} className={classes.nested}>
                            <ListItemText primary="Workunits" />
                        </ListItem>
                    </List>
                </Collapse>
                <Collapse in={open === "Files"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"XrefQueryWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Queries"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"QuerySetQueryWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Queries"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => setMainWidget({widget:"PackageMapQueryWidget", params:{}})} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"TopologyWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"DiskUsageWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"TargetClustersQueryWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"CluserProcessesQueryWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"SystemServersQueryWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"UserQueryWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"MonitoringWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"DynamicESDLQueryWidget", params:{}}) }} className={classes.nested}>
                ...
                <Collapse in={open === "Operations"} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItem button onClick={() => { setMainWidget({widget:"IFrameWidget&src=http%3A%2F%2F10.240.61.210%3A5601%2Fapp%2Fkibana%23%2Fdashboard%2FMetricbeat-system-overview-ecs%3F_g%3D(refreshInterval%253A(pause%253A!t%252Cvalue%253A300000)%252Ctime%253A(from%253Anow%252Fd%252Cto%253Anow%252Fd))&__filter=isTrusted%3Dfalse%26screenX%3D0%26screenY%3D0%26clientX%3D0%26clientY%3D0%26ctrlKey%3Dfalse%26shiftKey%3Dfalse%26altKey%3Dfalse%26metaKey%3Dfalse%26button%3D0%26buttons%3D0%26pageX%3D0%26pageY%3D0%26x%3D0%26y%3D0%26offsetX%3D0%26offsetY%3D0%26movementX%3D0%26movementY%3D0%26toElement%3D%255Bobject%2520HTMLInputElement%255D%26layerX%3D-1280%26layerY%3D9994%26getModifierState%3Dfunction%2520getModifierState()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26initMouseEvent%3Dfunction%2520initMouseEvent()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26view%3D%255Bobject%2520Window%255D%26detail%3D0%26which%3D1%26initUIEvent%3Dfunction%2520initUIEvent()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26NONE%3D0%26CAPTURING_PHASE%3D1%26AT_TARGET%3D2%26BUBBLING_PHASE%3D3%26type%3Dclick%26target%3D%255Bobject%2520HTMLInputElement%255D%26currentTarget%3D%255Bobject%2520HTMLInputElement%255D%26eventPhase%3D2%26bubbles%3Dtrue%26cancelable%3Dtrue%26defaultPrevented%3Dfalse%26composed%3Dtrue%26timeStamp%3D265185.10500000045%26srcElement%3D%255Bobject%2520HTMLInputElement%255D%26returnValue%3Dtrue%26cancelBubble%3Dfalse%26path%3D%255Bobject%2520HTMLInputElement%255D%26path%3D%255Bobject%2520HTMLSpanElement%255D%26path%3D%255Bobject%2520HTMLDivElement%255D%26path%3D%255Bobject%2520HTMLDivElement%255D%26path%3D%255Bobject%2520HTMLDivElement%255D%26path%3D%255Bobject%2520HTMLBodyElement%255D%26path%3D%255Bobject%2520HTMLHtmlElement%255D%26path%3D%255Bobject%2520HTMLDocument%255D%26path%3D%255Bobject%2520Window%255D%26composedPath%3Dfunction%2520composedPath()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26stopPropagation%3Dfunction%2520stopPropagation()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26stopImmediatePropagation%3Dfunction%2520stopImmediatePropagation()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26preventDefault%3Dfunction%2520preventDefault()%2520%257B%2520%255Bnative%2520code%255D%2520%257D%26initEvent%3Dfunction%2520initEvent()%2520%257B%2520%255Bnative%2520code%255D%2520%257D", params:{}}) }} className={classes.nested}>
